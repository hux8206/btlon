...
<html lang="en">
  ...
  <body>
    <!-- 1. THANH ĐIỀU HƯỚNG (NAVBAR) - Màu trắng -->
    <nav class="bg-white shadow-md sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <!-- Menu Chính (Đăng nhập/Đăng ký) -->
          <div class="flex items-center space-x-4">
            <a href="#" class="text-sm font-medium text-gray-700 hover:text-custom-main hidden sm:block">
              Tìm kiếm Bài học
            </a>
            <button class="px-4 py-2 text-sm font-medium rounded-full text-gray-700 hover:bg-gray-100 focus-ring-cyan transition">
              Đăng nhập
            </button>
            <button class="px-4 py-2 text-sm font-medium rounded-full text-white bg-custom-main hover:bg-custom-dark focus-ring-cyan transition shadow-lg">
              Đăng ký
            </button>
          </div>
        </div>
      ...
      <div class="mb-10">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div class="bg-white p-4 rounded-xl card-shadow hover:shadow-xl transition duration-300 transform hover:-translate-y-0.5 cursor-pointer flex flex-col items-center justify-center space-y-2">
                  <i class="fas fa-briefcase text-3xl text-yellow-600"></i>
                  <span class="font-semibold text-gray-800 text-center">Tiếng Anh Công Sở</span>
              </div>
              <!-- Category Card 2: IELTS -->
              <div class="bg-white p-4 rounded-xl card-shadow hover:shadow-xl transition duration-300 transform hover:-translate-y-0.5 cursor-pointer flex flex-col items-center justify-center space-y-2">
                  <i class="fas fa-graduation-cap text-3xl text-blue-600"></i>
                  <span class="font-semibold text-gray-800 text-center">Luyện Thi IELTS</span>
              </div>
              <!-- Category Card 3: Du Lịch -->
              <div class="bg-white p-4 rounded-xl card-shadow hover:shadow-xl transition duration-300 transform hover:-translate-y-0.5 cursor-pointer flex flex-col items-center justify-center space-y-2">
                  <i class="fas fa-globe-americas text-3xl text-green-600"></i>
                  <span class="font-semibold text-gray-800 text-center">Du Lịch & Văn Hóa</span>
              </div>
              <!-- Category Card 4: Ẩm Thực -->
              <div class="bg-white p-4 rounded-xl card-shadow hover:shadow-xl transition duration-300 transform hover:-translate-y-0.5 cursor-pointer flex flex-col items-center justify-center space-y-2">
                  <i class="fas fa-utensils text-3xl text-red-600"></i>
                  <span class="font-semibold text-gray-800 text-center">Ẩm Thực & Nấu Ăn</span>
              </div>
          </div>
      </div>
        ...
        <div class="cta-bg p-10 rounded-2xl card-shadow">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-lg text-gray-600 mb-8">
                    Lên kế hoạch cho bài học tiếp theo và điều chỉnh nó theo nhu cầu của mọi học viên chỉ trong vài phút.
                </p>
