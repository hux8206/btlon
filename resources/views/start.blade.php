    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center space-x-4">
          ...
          <a class="px-4 py-2 text-sm font-medium rounded-full text-gray-700 hover:bg-gray-100 focus-ring-cyan transition" href="{{ route('login') }}">
            Đăng nhập
          </a>
          <a class="px-4 py-2 text-sm font-medium rounded-full text-white bg-custom-main hover:bg-custom-dark focus-ring-cyan transition shadow-lg" href="{{ route('register') }}">
            Đăng ký
          </a>
        </div>
      </div>
